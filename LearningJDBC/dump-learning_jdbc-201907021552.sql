...
--
-- Table structure for table `persons_tmp`
--
...
--
-- Dumping data for table `persons_tmp`
--

LOCK TABLES `persons_tmp` WRITE;
/*!40000 ALTER TABLE `persons_tmp` DISABLE KEYS */;
INSERT INTO `persons_tmp` VALUES (16,'vasya','vas123','Vasiliy','Sidorov','1985-03-10',880.00),(17,'vasya','vas123','Vasiliy','Sidorov','1985-03-10',550.00),(18,'megabrain','pass','Albert','Einstain','1879-03-14',3500.00),(19,'стасямба','1стасололо6','Станистав','Кину Где Попало','1986-09-14',500.00),(20,'Siarhei','pas324','Siarhei','Melez','1965-07-02',320.00),(21,'sequoya','seq345','Sequoya','The Three','0001-01-01',50000.00),(22,'astronaut','lely','Astronaut','A5 Naebali','2019-05-15',1.00),(23,'juno','j159','Lely','Juno','2010-03-15',357.00),(24,'test','test','TEST','USER','2000-01-01',0.00),(25,'lgogog','12345678','sdgsg','sdgjhserargh','1987-03-20',-100.00);
/*!40000 ALTER TABLE `persons_tmp` ENABLE KEYS */;
UNLOCK TABLES;
