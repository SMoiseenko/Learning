...
public class TextRepair {
  ...
  private static final Logger LOG = LogManager.getLogger(TextRepair.class.getName());
  ...
  public static StringBuilder scanFile(File file) {
  ...
  public static void writeToFile(StringBuilder text, File file) {
    String fileName =
  ...
  public static File[] getHtmlArray() {
